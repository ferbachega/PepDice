...
system = Molecule()
name = 'poliALa_from_sequence_Harm_restraints'
...
system.set_energy_model('RAW')
                                                    ...
                                                    #AAAAAAAA
system.import_SS_restraints_from_string (      ss = 'HHHHHHHHH', 
                                            w_ss  = '012343210', log= True)
print system.compute_SS_energy(log = True)

system.energy_components['SS_RESTRAINT']  [1]= 0.0 
...
system.energy_components['DIST_RESTRAINT'][1]= 1.0
