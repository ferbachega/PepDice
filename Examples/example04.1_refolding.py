...
system.load_PDB_to_system      (filename = os.path.join(PEPDICE_EXAMPLES , 'data/1gab_ff03ua_AMBER_extended.pdb')) #/home/fernando/programs/pepdice/Examples/data/1gab_ff03ua_AMBER_extended.pdb
...
save_PDB_to_file(system,  os.path.join(PEPDICE_EXAMPLES , 'outputs/1gab_amber_example04.1_ff03ua_refold.pdb'))
#------------------------------------------------------------------------------------------------------
