    ...
    if line2[0] == 'DECOY':
        ...
        if len(line2) > 0:
            if 'nan' in line2:
                ...
                ANGLE     .append(float(line2[6] ))
                BOND      .append(float(line2[7] ))
                DIHED     .append(float(line2[8] ))
                EEL       .append(float(line2[9] ))
                EELEC     .append(float(line2[10]))
                EGB       .append(float(line2[11]))
                ESURF     .append(float(line2[12]))
                NB        .append(float(line2[13]))
                VDWAALS   .append(float(line2[14]))
