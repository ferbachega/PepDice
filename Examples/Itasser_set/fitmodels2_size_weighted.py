    ...
    if line2[0] == 'DECOY':
        ...
        if len(line2) > 0:
            if 'nan' in line2:
                ...
                contacts_0.append(float(line2[4] )) #/ float(line2[3]) )
                contacts_1.append(float(line2[5] )) #/ float(line2[3]) )
                contacts_2.append(float(line2[6] )) #/ float(line2[3]) )
                contacts_3.append(float(line2[7] )) #/ float(line2[3]) )
                contacts_4.append(float(line2[8] )) #/ float(line2[3]) )
                contacts_5.append(float(line2[9] )) #/ float(line2[3]) )
                AB_ENERGY .append(float(line2[10])) #/ float(line2[3]) )
                ANGLE     .append(float(line2[11])) #/ float(line2[3]) )
                BOND      .append(float(line2[12])) #/ float(line2[3]) )
                DIHED     .append(float(line2[13])) #/ float(line2[3]) )
                EEL       .append(float(line2[14])) #/ float(line2[3]) )
                EELEC     .append(float(line2[15])) #/ float(line2[3]) )
                EGB       .append(float(line2[16])) #/ float(line2[3]) )
                ESURF     .append(float(line2[17])) #/ float(line2[3]) )
                NB        .append(float(line2[18])) #/ float(line2[3]) )
                VDWAALS   .append(float(line2[19])   / float(line2[3]) )
