...
save_PDB_to_file(system,  os.path.join(PEPDICE_EXAMPLES , 'outputs/example04_1gab_extended.pdb'))
#------------------------------------------------------------------------------------------------------
...
save_PDB_to_file(system,  os.path.join(PEPDICE_EXAMPLES , 'outputs/example04_1gab_refold.pdb'))
#------------------------------------------------------------------------------------------------------
